  ...
  <tr> 
    <td class="row1"><table border="0" cellpadding="3" cellspacing="1" width="100%">
          ...
          <tr> 
            ...
            <td> 
              <input type="text" name="login" size="25" maxlength="40" value="{USERNAME}" />
            </td>
          </tr>
          <tr> 
          ...
          <tr align="center"> 
            <td colspan="2"><span class="gen">{L_AUTO_LOGIN}: <input type="checkbox" name="remember" /></span></td>
          </tr>
          <tr align="center"> 
            <td colspan="2">{S_HIDDEN_FIELDS}<input type="submit" name="loginbtn" class="mainoption" value="{L_LOGIN}" /></td>
          </tr>
          <tr align="center"> 
