...
<tr>
    <td colspan=3 background="/i/header_fon.gif" bgcolor="#E6E6E6" height=122 valign=top>
        <table width="100%" cellpadding=0 cellspacing=0 border=0>
            <tr>
                <td valign=top width="180"><a href="/"><img src="/i/logo.gif" width="180" height="122" border="0" alt="Math.ru"/></a></td>
                <td class=title valign=bottom><img src="/i/p.gif" width=20 height=1 /><br/><img src="/i/p.gif" width=1 height=33 /></td>
                <td align=right valign=top width="245"></td>
            </tr>
        </table>
    </td>
</tr>
<tr><td id="menu" height="5"></td><td id="content"></td><td id="right"></td></tr>
