...
<table width="100%" cellpadding=1 cellspacing=0 border=0><tr><td bgcolor="#CC0000" width="100%">
<table width="100%" cellpadding=0 cellspacing=0 border=0>
<tr><td class=tit_error height=18><img src="/i/s_error.png" width=16 height=16 hspace=0 vspace=0 border=0> Предупреждение</td></tr>
<tr><td class=tbldata1 valign=top>
<ul>
{section name=i loop=$warning}<li>{$warning[i]}{/section}
</ul>
</td></tr></table>
</td></tr></table>
{/if}