    ...
    <td colspan=3 background="/i/header_fon.gif" bgcolor="#6B7DB7" height=125 valign=top>
        <table width="100%" cellpadding=0 cellspacing=0 border=0>
            <tr>
                ...
                <td class=title valign=bottom><img src="/i/p.gif" width=20 height=1 /><a href="/teacher/"><img src="/i/tit/10.gif" alt="Учительская" hspace=8 border="0"/></a><br/><img src="/i/p.gif" width=1 height=27 /></td>
