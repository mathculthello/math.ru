...
{if $message}<hr><b>{$message}</b><hr>{/if}
<br/>
...
<tr><td class=tblheader1 width=150>Автор(ы)&nbsp;<a title="Обязательно для заполнения" href="#" style="color:red; font-size:20px;">*</a></td><td colspan=3><input type=text name=sauthor style="width:100%" value="{$sauthor}"></td><td></td></tr>
<tr><td class=tblheader1>Название&nbsp;<a title="Обязательно для заполнения" href="#" style="color:red; font-size:20px;">*</a></td><td colspan=3><input type=text name=stitle style="width:100%" value="{$stitle}"></td><td></td></tr>
<tr><td class=tblheader1>Издание, год</td><td colspan=3><input type=text name=publ style="width:100%" value="{$publ}"></td><td></td></tr>
<tr><td class=tblheader1 valign=top>Дополнительная информация</td><td colspan=3><textarea rows=3 name=info style="width:100%">{$info}</textarea></td><td></td></tr>
